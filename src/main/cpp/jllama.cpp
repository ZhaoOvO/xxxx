...
JNIEXPORT void JNICALL Java_cn_hthcorp_llama_LlamaModel_loadModel(JNIEnv *env, jobject obj, jobjectArray jparams)
{
...
JNIEXPORT void JNICALL Java_cn_hthcorp_llama_LlamaModel_releaseTask(JNIEnv *env, jobject obj, jint id_task)
{
    jlong server_handle = env->GetLongField(obj, f_model_pointer);
    auto *ctx_server = reinterpret_cast<server_context *>(server_handle); // NOLINT(*-no-int-to-ptr)
